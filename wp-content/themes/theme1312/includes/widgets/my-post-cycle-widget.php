...
class MY_CycleWidget extends WP_Widget {
    ...
    function widget($args, $instance) {		
        ...
        ?>
              ...
              <div id="slogan-controls">
                <ul id="nav-slogan"></ul>
                <a href="#"><span id="prev-slogan"></span></a> 
                <a href="#"><span id="next-slogan"></span></a>
              </div>
              <!-- end of slogan_cycle -->
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Post Type:', 'theme1312'); ?><br />
      ...
      <option value="slogan" <?php echo ($category === 'slogan' ? ' selected="selected"' : ''); ?> >Slogans</option>
