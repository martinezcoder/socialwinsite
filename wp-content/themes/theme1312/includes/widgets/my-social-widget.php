    ...
    echo $before_title . $title . $after_title;
		?>
			...
			<ul class="social-networks">
			    ...
			    <?php if (!empty($networks[$network])) : ?><li><a rel="external" title="<?php echo strtolower($network);?>" href="<?= $networks[$network] ?>"><?php if (($display == "both") or ($display =="icons")) { ?><img src="<?php bloginfo('stylesheet_directory'); ?>/images/icons/<?php echo strtolower($network);?>.png" alt=""><?php } if (($display == "labels") or ($display == "both")) {?> <?php echo $network; ?><?php } ?></a></li><?php endif; ?>
					<?php endforeach; ?>
