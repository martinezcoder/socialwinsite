...
function widget($args, $instance) {
  ...
  $cat_posts = new WP_Query(
	...
	<?php if ( $instance['global_link'] ) : ?>
	  <div class="link_show_all"><a href="<?php echo $instance['global_link_href']; ?>"><?php if($instance['global_link_text']==""){ ?>View all<?php }else{ ?><?php echo $instance['global_link_text']; ?><?php } ?></a></div>
	<?php endif; ?>
