...
(function( window, $, undefined ) {
	...
	$.Box3d.prototype 				= {
		...
		_addEnlaces		    : function() {
			this.Enlace 	= $('<span class="sb-clic-enlace">Enlace</span>');
			
			var $sbNav		= $('<div class="sb-enlace">').append( this.Enlace );
		...
		_initEvents			: function( options ) {
			...
			instance.Enlace.bind('click.slicebox', function( event ) {
				instance._showEnlace();
			});

		},
		_showEnlace			: function() {
			var redireccion	= this.$images.eq(this.imageCurrent).attr('title');
